...
# source: c2board/src/attr_value.proto
...
_ATTRVALUE_LISTVALUE.fields_by_name['type'].enum_type = c2board_dot_src_dot_types__pb2._DATATYPE
_ATTRVALUE_LISTVALUE.fields_by_name['shape'].message_type = c2board_dot_src_dot_tensor__shape__pb2._TENSORSHAPEPROTO
_ATTRVALUE_LISTVALUE.fields_by_name['tensor'].message_type = c2board_dot_src_dot_tensor__pb2._TENSORPROTO
_ATTRVALUE_LISTVALUE.fields_by_name['func'].message_type = _NAMEATTRLIST
_ATTRVALUE_LISTVALUE.containing_type = _ATTRVALUE
_ATTRVALUE.fields_by_name['type'].enum_type = c2board_dot_src_dot_types__pb2._DATATYPE
_ATTRVALUE.fields_by_name['shape'].message_type = c2board_dot_src_dot_tensor__shape__pb2._TENSORSHAPEPROTO
_ATTRVALUE.fields_by_name['tensor'].message_type = c2board_dot_src_dot_tensor__pb2._TENSORPROTO
...
AttrValue = _reflection.GeneratedProtocolMessageType('AttrValue', (_message.Message,), dict(
  ...
  ListValue = _reflection.GeneratedProtocolMessageType('ListValue', (_message.Message,), dict(
    ...
    __module__ = 'c2board.src.attr_value_pb2'
