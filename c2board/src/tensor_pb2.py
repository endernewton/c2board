...
# source: c2board/src/tensor.proto
...
from c2board.src import resource_handle_pb2 as c2board_dot_src_dot_resource__handle__pb2
...
_TENSORPROTO.fields_by_name['dtype'].enum_type = c2board_dot_src_dot_types__pb2._DATATYPE
_TENSORPROTO.fields_by_name['tensor_shape'].message_type = c2board_dot_src_dot_tensor__shape__pb2._TENSORSHAPEPROTO
_TENSORPROTO.fields_by_name['resource_handle_val'].message_type = c2board_dot_src_dot_resource__handle__pb2._RESOURCEHANDLEPROTO
...
TensorProto = _reflection.GeneratedProtocolMessageType('TensorProto', (_message.Message,), dict(
  ...
  __module__ = 'c2board.src.tensor_pb2'
