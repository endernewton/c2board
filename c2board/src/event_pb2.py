...
# source: c2board/src/event.proto
...
_EVENT.fields_by_name['summary'].message_type = c2board_dot_src_dot_summary__pb2._SUMMARY
...
Event = _reflection.GeneratedProtocolMessageType('Event', (_message.Message,), dict(
  DESCRIPTOR = _EVENT,
  __module__ = 'c2board.src.event_pb2'
