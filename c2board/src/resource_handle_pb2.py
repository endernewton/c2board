...
# source: c2board/src/resource_handle.proto
...
ResourceHandleProto = _reflection.GeneratedProtocolMessageType('ResourceHandleProto', (_message.Message,), dict(
  ...
  __module__ = 'c2board.src.resource_handle_pb2'
