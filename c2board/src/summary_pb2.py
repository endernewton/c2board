...
# source: c2board/src/summary.proto
...
_SUMMARY_VALUE.fields_by_name['tensor'].message_type = c2board_dot_src_dot_tensor__pb2._TENSORPROTO
...
SummaryDescription = _reflection.GeneratedProtocolMessageType('SummaryDescription', (_message.Message,), dict(
  ...
  __module__ = 'c2board.src.summary_pb2'
