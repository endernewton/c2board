...
# source: c2board/src/node_def.proto
...
_NODEDEF_ATTRENTRY.fields_by_name['value'].message_type = c2board_dot_src_dot_attr__value__pb2._ATTRVALUE
...
NodeDef = _reflection.GeneratedProtocolMessageType('NodeDef', (_message.Message,), dict(
  ...
  AttrEntry = _reflection.GeneratedProtocolMessageType('AttrEntry', (_message.Message,), dict(
    ...
    __module__ = 'c2board.src.node_def_pb2'
